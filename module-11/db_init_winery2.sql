...
INSERT INTO Supply_Delivery (supply_id, expected_delivery, actual_delivery, quantity) VALUES
    -- Bottles and Corks Co. (supplies: Bottles = 1, Corks = 2)
    (1, '2025-01-01', '2025-01-03', 1000),
    (2, '2025-01-01', '2025-01-03', 500),
    (1, '2025-02-01', '2025-02-02', 950),
    (2, '2025-02-01', '2025-02-02', 520),
    (1, '2025-03-01', '2025-03-04', 1000),
    (2, '2025-03-01', '2025-03-04', 500),

    -- Labels and Boxes Ltd. (supplies: Labels = 3, Boxes = 4)
    (3, '2025-01-10', '2025-01-10', 800),
    (4, '2025-01-10', '2025-01-10', 600),
    (3, '2025-02-10', '2025-02-12', 750),
    (4, '2025-02-10', '2025-02-12', 650),
    (3, '2025-03-10', '2025-03-14', 700),
    (4, '2025-03-10', '2025-03-14', 620),

    -- Tubes and Vats Brothers (supplies: Vats = 5, Tubing = 6)
    (5, '2025-01-15', '2025-01-16', 5),
    (6, '2025-01-15', '2025-01-16', 100),
    (5, '2025-02-15', '2025-02-17', 6),
    (6, '2025-02-15', '2025-02-17', 105),
    (5, '2025-03-15', '2025-03-15', 7),
    (6, '2025-03-15', '2025-03-15', 110);
